  ...
  <div class="page">
    <header class="topbar">
      ...
      <div class="student-menu">
        <button class="about-btn" type="button" @click="showAboutDialog = true">About Us</button>
    ...
    <div v-if="showAboutDialog" class="dialog-overlay" @click.self="showAboutDialog = false">
      <div class="about-dialog">
        <div class="about-icon">i</div>
        <h2>About I-SPAS</h2>
        <p>I-SPAS is an Intranet-Based Student Performance Assessment System designed to support classroom assessments and student performance monitoring.</p>
        ...
        <button class="about-close-btn" type="button" @click="showAboutDialog = false">Close</button>
      </div>
    </div>
    <div
